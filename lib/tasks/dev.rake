namespace :dev do
  ...
  task prime: :environment do
    ...
    Photo.destroy_all
    photos = [
      { id: 1, room_id: 1, remote_url_url: "https://a0.muscache.com/im/pictures/d48fb432-9c5c-4b28-b3d6-ef35cc60a0aa.jpg?im_w=1200", created_at: 1.day.ago, updated_at: 1.day.ago},
      { id: 2, room_id: 1, remote_url_url: "https://a0.muscache.com/im/pictures/246c32c4-a025-49e9-a0a2-ecf576552825.jpg?im_w=720", created_at: 1.day.ago, updated_at: 1.day.ago},
      { id: 3, room_id: 1, remote_url_url: "https://a0.muscache.com/im/pictures/0baa1493-828e-4e26-bcb6-4ff303878113.jpg?im_w=720", created_at: 1.day.ago, updated_at: 1.day.ago},
      { id: 4, room_id: 1, remote_url_url: "https://a0.muscache.com/im/pictures/61ce4a40-3db5-4f80-9176-fc134e0a4b02.jpg?im_w=1200", created_at: 1.day.ago, updated_at: 1.day.ago},
      { id: 5, room_id: 2, remote_url_url: "https://a0.muscache.com/im/pictures/ef9eb74e-7686-4778-943f-af551f2e4979.jpg?im_w=1200"},
      { id: 6, room_id: 2, remote_url_url: "https://a0.muscache.com/im/pictures/13ba6a0f-5392-44b6-94d6-3fc64c972434.jpg?im_w=720"},
      { id: 7, room_id: 2, remote_url_url: "https://a0.muscache.com/im/pictures/48f19fe3-89dc-4a4b-9283-e26429ad54e4.jpg?im_w=720"},
      { id: 8, room_id: 2, remote_url_url: "https://a0.muscache.com/im/pictures/a3449710-b3fd-417e-83f4-2128c1bbc379.jpg?im_w=720"},
      { id: 9, room_id: 2, remote_url_url: "https://a0.muscache.com/im/pictures/1d9824ce-6ae3-4a78-bb92-c3e8fe4039e7.jpg?im_w=720"},
      ...
      { id: 15, room_id: 3, remote_url_url: "https://a0.muscache.com/im/pictures/cd60f24d-e806-4521-86dc-bf23622b30f4.jpg?im_w=1200"},
      { id: 16, room_id: 3, remote_url_url: "https://a0.muscache.com/im/pictures/0bcf8e58-13f1-4516-b68c-980fc0d0c4b9.jpg?im_w=720"},
      { id: 17, room_id: 3, remote_url_url: "https://a0.muscache.com/im/pictures/1c796d9b-6ad3-4fc3-82ff-11a8e43e60c9.jpg?im_w=720"},
      { id: 18, room_id: 3, remote_url_url: "https://a0.muscache.com/im/pictures/9d32edf4-c205-4143-9639-b5f15ce5f5cf.jpg?im_w=720"},
      { id: 19, room_id: 3, remote_url_url: "https://a0.muscache.com/im/pictures/4e77b64a-de37-4324-b800-dafabf65f80a.jpg?im_w=720"},
      { id: 20, room_id: 4, remote_url_url: "https://a0.muscache.com/im/pictures/b6cd7fa2-523d-43a6-807b-f8e03961939e.jpg?im_w=1200"},
      { id: 21, room_id: 4, remote_url_url: "https://a0.muscache.com/im/pictures/5df40781-f2b7-4801-9170-5e8d7051b317.jpg?im_w=720"},
      { id: 22, room_id: 4, remote_url_url: "https://a0.muscache.com/im/pictures/848c23a5-8202-40da-9643-e4b84a1db963.jpg?im_w=720"},
      { id: 23, room_id: 5, remote_url_url: "https://a0.muscache.com/im/pictures/b0d8fb6d-09be-45b0-9666-2d9d77406b85.jpg?im_w=1200"},
      { id: 24, room_id: 5, remote_url_url: "https://a0.muscache.com/im/pictures/miso/Hosting-35594574/original/bf5080ce-d311-4e76-9e45-009a6f688404.jpeg?im_w=720"},
      { id: 25, room_id: 5, remote_url_url: "https://a0.muscache.com/im/pictures/6e5c3053-6a51-419d-bbd4-02071fc8ef71.jpg?im_w=720"},
      { id: 26, room_id: 6, remote_url_url: "https://a0.muscache.com/im/pictures/e626bbdc-f0f3-4fc7-86f4-aa94cb071960.jpg?im_w=1200"},
      { id: 27, room_id: 6, remote_url_url: "https://a0.muscache.com/im/pictures/55f9421a-dc48-4232-9295-bcd11ec08bf5.jpg?im_w=720"},
      { id: 28, room_id: 6, remote_url_url: "https://a0.muscache.com/im/pictures/a634085b-b588-479d-bb1a-8a7fe41ef27b.jpg?im_w=720"},
      { id: 29, room_id: 8, remote_url_url: "https://a0.muscache.com/im/pictures/e83fe5e3-e7fe-4b7a-8e3a-bfecf5a5b1d9.jpg?im_w=1200"},
      { id: 30, room_id: 8, remote_url_url: "https://a0.muscache.com/im/pictures/f55284b4-4b69-4238-abf6-51a56a8c2b47.jpg?im_w=720"},
